...
class Forest (location.SubLocation):
    def __init__ (self, m):
        ...
        #self.event_chance = 50
        #self.events.append(knight_and_knave.KnightAndKnave())
        ...
        #self.events.append(drowned_pirates.DrownedPirates())
        self.events.append(skeleton_attack.KillerSkeletons())
    ...
    def enter (self):
        ...
        description = "You walk into the forest on the island."
        '''if edibles == False:
